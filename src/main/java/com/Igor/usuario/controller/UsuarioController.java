package com.Igor.usuario.controller;

import com.Igor.usuario.business.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioDTO> atualizaDadosUsuario(@RequestBody UsuarioDTO dto,
        ...
        return ResponseEntity.ok(usuarioService.autalizaDadosUsuario(token, dto));
    }
    ...
    public ResponseEntity<TelefoneDTO> atualizaTelefone(@RequestBody TelefoneDTO dto,
                                                        @RequestParam("id") Long id){
        return ResponseEntity.ok(usuarioService.atulizaTelefone(id, dto));
    }
